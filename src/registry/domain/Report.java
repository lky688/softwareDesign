...
public class Report {
    ...
    public void generateSessionsReport() {
        ...
        System.out.println("=======================================================");
        System.out.println("Generated by: " + generatedBy.getName() + " | " + generatedBy.getEmail());
        System.out.println("Generated at: " + formatDateTime(generatedAt) + "\n");
        System.out.println("-------------------------------------------------------");
        ...
        for (Session session : sessions) {
            ...
            if (students.isEmpty()) {
                System.out.println("No students have joined this session yet");
            } else {
